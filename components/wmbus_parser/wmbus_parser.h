...
// Include the driver header relative to this component so the compiler can
// always locate it, even when the component directory is copied without the
// top-level ``esphome`` path (as PlatformIO does under ``src/``).
